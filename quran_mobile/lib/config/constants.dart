class AppConstants {
  ...
  static const String apiBaseUrlPhysical = 'http://192.168.1.100:8000/api'; // Change to your PC's IP
  ...
  // Section types
  static const String sectionHifz = 'hifz';
  static const String sectionSabqi = 'sabqi';
  static const String sectionRevision = 'revision';

  // Section labels
  static const Map<String, String> sectionLabels = {
    sectionHifz: 'Memorization (Hifz)',
    sectionSabqi: 'Sabqi (Recent)',
    sectionRevision: 'Revision (Manzil)',
  };
