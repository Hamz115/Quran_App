...
- None — straightforward addition since class data was already loaded

## Files Changed

| File | Action | Description |
|------|--------|-------------|
| `quran_frontend/src/pages/TeacherDashboard.tsx` | Modified | Added `surahNames` import + Recent Classes section with 4-card grid |
