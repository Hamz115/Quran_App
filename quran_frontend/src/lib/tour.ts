...
export const TOUR_STEPS: TourStepDef[] = [
  ...
  },
  {
    ...
    title: 'Add Contacts',
    description: '<strong>Click “Add Contact”</strong> to see how contacts are added to your roster.',
    side: 'left',
    align: 'start',
    type: 'interactive',
  ...
  {
    screen: 'dashboard',
    element: '[data-tour="close-add-contact-dialog"]',
    title: 'Find a QuranTrack Contact',
    description: 'Search using the email address connected to the person’s existing QuranTrack account. You do not need to enter one during this tour. <strong>Click × to close.</strong>',
    side: 'left',
    align: 'start',
    type: 'interactive',
    interactiveTarget: '[data-tour="close-add-contact-dialog"]',
    waitForElement: '[data-tour="close-add-contact-dialog"]',
  },
  {
    screen: 'dashboard',
